...
"   call Decho("put modifed text back into file (beginning=".begline.".".begcol.")")
   ...
   let begcol= begcol+1
   let endcol= endcol+1
   silent exe "keepj ".begline
   silent exe 'keepj norm! '.begcol."\<bar>".vmode
   silent exe "keepj ".endline
   silent exe 'keepj norm! '.endcol."\<bar>\<esc>"
   silent exe "keepj ".begline
   silent exe 'keepj norm! '.begcol."\<bar>"
  endif
